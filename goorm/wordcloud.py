...
# Wordcloud
#
# Original Author: Andreas Christian Mueller <t3kcit@gmail.com>
#
# (c) 2012
#
# Modified by: Paul Nechifor <paul@nechifor.net>
#
# Korean adaptation: Taylor Jung <iam@nyanye.com>
#
# License: MIT
...
class WordCloud(object):
    ...
    def __init__(self, font_path=None, width=400, height=200, margin=2,
                 ...
                 random_state=None, background_color='white',
    ...
    def generate_from_text(self, text):
        words = Counter(mecab.nouns(text)).most_common()
